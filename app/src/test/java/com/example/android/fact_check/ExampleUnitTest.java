...
public class ExampleUnitTest {
    ...
    @Mock
    private MainActivity.getImage getimage;
    @Mock
...
//        mockedModelClass = mock(ModelClass.class);
//        try {
////            jsonObject = new JSONObject(response);
////            jsonObject= jsonObject.getJSONObject("claims");
...
//        }
        ...
        getimage.execute();
        mockedModelClass.setClaim(search.claims.get(0).text);
        mockedModelClass.setClaimant(search.claims.get(0).claimant);
        mockedModelClass.setReview(search.claims.get(0).claimReview.get(0).textualRating);
